package org.example.moomyeongso.admin.topic.controller;

import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;
import jakarta.validation.Valid;
import lombok.RequiredArgsConstructor;
import org.example.moomyeongso.admin.topic.service.AdminTopicService;
...
public class AdminTopicController {
    ...
    @PostMapping("/topics")
    public ResponseEntity<Void> createTopic(@Valid @RequestBody TopicRequestDto requestDto) {
